...
export default function CaseStudiesAdminForm({
  ...
  return (
    <div className="flex flex-col gap-3">
      {items.map((it, i) => (
        <div key={i} className="flex flex-col gap-2 rounded-md border border-neutral-200 bg-white p-3">
          <input
            placeholder="Title"
            value={it.title}
          ...
          />
          <button type="button" onClick={() => remove(i)} className="flex items-center gap-1 self-start text-xs text-red-600">
